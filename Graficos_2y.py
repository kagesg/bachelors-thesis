...
eq_e1_px = [[10,27.8,10],[736,855,738],[4.5,11,9.5],[10,10,27.8],[750,855,739],[4.5,9,9]]
eq_e2_px = [[26,10,10],[740,740,740],[3,2.1,4],[10,27,10],[740,852,740],[3,2.1,4]]
...
eq_e1_py = [[179,201,199],[178,216,200],[181,203,212],[174,190,211],[176,213,198],[181,206,224]]
eq_e2_py = [[14.1,11.5,8.8],[13.2,10.6,7.6],[10.6,14.5,15],[9.3,13,12.8],[9.4,13.4,13.2],[11.4,15.1,15.2]]
...
eq_e1 = [[r'${0,5854x+176,78}$'+'\n'+r'${R^2 = 0,9993}$',r'${0,5831x+181,09}$'+'\n'+r'${R^2 = 0,9993}$',r'${0,5727x+189,91}$'+'\n'+r'${R^2 = 0,9995}$'],
        [r'${0,2267x+14,667}$'+'\n'+r'${R^2 = 0,9998}$',r'${0,2265x+18,989}$'+'\n'+r'${R^2 = 0,9998}$',r'${0,2236x+29,908}$'+'\n'+r'${R^2 = 0,9997}$'],
        [r'${-0,79x^2+2,559x+190,58}$'+'\n'+r'${R^2 = 0,9987}$',r'${178,38x^{0,0484}}$'+'\n'+r'${R^2 = 0,998}$',r'${-0,0771x^2+2,5653x+175,9}$'+'\n'+r'${R^2 = 0,9991}$'],
        [r'${0,5802x+172,31}$'+'\n'+r'${R^2 = 0,9992}$',r'${0,5831x+181,09}$'+'\n'+r'${R^2 = 0,9993}$',r'${0,5786x+199,40}$'+'\n'+r'${R^2 = 0,9996}$'],
        [r'${0,2254x+11,202}$'+'\n'+r'${R^2 = 0,9998}$',r'${0,2254x+16,952}$'+'\n'+r'${R^2 = 0,9998}$',r'${0,2259x+25,392}$'+'\n'+r'${R^2 = 0,9998}$'],
        [r'${-0,0818x^2+2,6326x+175,54}$'+'\n'+r'${R^2 = 0,999}$',r'${-0,0798x^2+2,5718x+184,65}$'+'\n'+r'${R^2 = 0,9984}$',r'${-0,0782x^2+2,5232x+203,13}$'+'\n'+r'${R^2 = 0,9992}$']]

eq_e2 = [[r'${0,0015x^2+0,0796x+11,952}$'+'\n'+r'${R^2 = 1}$',r'${0,0008x^2+0,0597x+10,19}$'+'\n'+r'${R^2 = 1}$',r'${0,0004x^2+0,0359x+7,8862}$'+'\n'+r'${R^2 = 1}$'],
        [r'${0,0216x-2,0336}$'+'\n'+r'${R^2 = 1}$',r'${0,0179x-1,7773}$'+'\n'+r'${R^2 = 1}$',r'${0,0134x-1,4406}$'+'\n'+r'${R^2 = 1}$'],
        [r'${18,2x^{-0,319}}$'+'\n'+r'${R^2 = 0,9996}$',r'${20,478x^{-0,345}}$'+'\n'+r'${R^2 = 0,9993}$',r'${25,188x^{-0,393}}$'+'\n'+r'${R^2 = 0,9988}$'],
        [r'${0,0008x^2+0,0559x+9,6072}$'+'\n'+r'${R^2 = 1}$',r'${0,0008x^2+0,0597x+10,19}$'+'\n'+r'${R^2 = 1}$',r'${0,0009x^2+0,0679x+11,361}$'+'\n'+r'${R^2 = 1}$'],
        [r'${0,0157x-1,4055}$'+'\n'+r'${R^2 = 1}$',r'${0,0171x-1,6267}$'+'\n'+r'${R^2 = 1}$',r'${0,0197x-2,055}$'+'\n'+r'${R^2 = 1}$'],
        [r'${20,593x^{-0,36}}$'+'\n'+r'${R^2 = 0,9992}$',r'${21,848x^{-0,36}}$'+'\n'+r'${R^2 = 0,9992}$',r'${24,359x^{-0,358}}$'+'\n'+r'${R^2 = 0,9992}$']]
...
axs[0,0].text(eq_e1_px[modo][0],eq_e1_py[modo][0],eq_e1[modo][0],fontsize=f_size-1,bbox={'facecolor': '#FFFFFF','edgecolor':'none','alpha': alpha,'pad': pad,'boxstyle':'round, pad=0.25'})
...
axs[1,0].text(eq_e2_px[modo][0],eq_e2_py[modo][0],eq_e2[modo][0],fontsize=f_size-1,bbox={'facecolor': '#FFFFFF','edgecolor':'none','alpha': alpha,'pad': pad,'boxstyle':'round, pad=0.25'})
...
axs[0,1].text(eq_e1_px[modo+3][0],eq_e1_py[modo+3][0],eq_e1[modo+3][0],fontsize=f_size-1,bbox={'facecolor': '#FFFFFF','edgecolor':'none','alpha': alpha,'pad': pad,'boxstyle':'round, pad=0.25'})
...
axs[1,1].text(eq_e2_px[modo+3][0],eq_e2_py[modo+3][0],eq_e2[modo+3][0],fontsize=f_size-1,bbox={'facecolor': '#FFFFFF','edgecolor':'none','alpha': alpha,'pad': pad,'boxstyle':'round, pad=0.25'})
...
axs[0,0].text(eq_e1_px[modo][1],eq_e1_py[modo][1],eq_e1[modo][1],fontsize=f_size-1,bbox={'facecolor': '#FFFFFF','edgecolor':'none','alpha': alpha,'pad': pad,'boxstyle':'round, pad=0.25'})
...
axs[1,0].text(eq_e2_px[modo][1],eq_e2_py[modo][1],eq_e2[modo][1],fontsize=f_size-1,bbox={'facecolor': '#FFFFFF','edgecolor':'none','alpha': alpha,'pad': pad,'boxstyle':'round, pad=0.25'})
...
axs[0,1].text(eq_e1_px[modo+3][1],eq_e1_py[modo+3][1],eq_e1[modo+3][1],fontsize=f_size-1,bbox={'facecolor': '#FFFFFF','edgecolor':'none','alpha': alpha,'pad': pad,'boxstyle':'round, pad=0.25'})
...
axs[1,1].text(eq_e2_px[modo+3][1],eq_e2_py[modo+3][1],eq_e2[modo+3][1],fontsize=f_size-1,bbox={'facecolor': '#FFFFFF','edgecolor':'none','alpha': alpha,'pad': pad,'boxstyle':'round, pad=0.25'})
...
axs[0,0].text(eq_e1_px[modo][2],eq_e1_py[modo][2],eq_e1[modo][2],fontsize=f_size-1,bbox={'facecolor': '#FFFFFF','edgecolor':'none','alpha': alpha,'pad': pad,'boxstyle':'round, pad=0.25'})
...
axs[1,0].text(eq_e2_px[modo][2],eq_e2_py[modo][2],eq_e2[modo][2],fontsize=f_size-1,bbox={'facecolor': '#FFFFFF','edgecolor':'none','alpha': alpha,'pad': pad,'boxstyle':'round, pad=0.25'})
...
axs[0,1].text(eq_e1_px[modo+3][2],eq_e1_py[modo+3][2],eq_e1[modo+3][2],fontsize=f_size-1,bbox={'facecolor': '#FFFFFF','edgecolor':'none','alpha': alpha,'pad': pad,'boxstyle':'round, pad=0.25'})
...
axs[1,1].text(eq_e2_px[modo+3][2],eq_e2_py[modo+3][2],eq_e2[modo+3][2],fontsize=f_size-1,bbox={'facecolor': '#FFFFFF','edgecolor':'none','alpha': alpha,'pad': pad,'boxstyle':'round, pad=0.25'})
